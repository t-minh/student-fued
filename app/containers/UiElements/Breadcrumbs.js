  ...
  render() {
    ...
    return (
      <div>
        ...
        <PapperBlock title="Classic Breadcrumb" icon="ios-arrow-forward" desc="Breadcrumb is one of navigation component. With this User can jump to parent, children or grand-children Fun Quizs long in a single inheritance.This example is designed with classic style separator">
          <div>
            <ClassicBreadcrumbs />

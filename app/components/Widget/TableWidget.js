...
const data = [
  createData('QWE123', 'Woman Bag', '23 Oct 2021', 300, avatarApi[6], 'John Doe', imgApi[21], 'blur_on', 14, 30, 'Error', 'Canceled'),
  createData('ABC890', 'Laptop', '11 Nov 2021', 230, avatarApi[8], 'Jim Doe', imgApi[29], 'computer', 25, 70, 'Success', 'Sent'),
  createData('GHI556', 'Pinapple Jam', '5 Nov 2021', 34, avatarApi[2], 'Jane Doe', imgApi[25], 'restaurant_menu', 35, 50, 'Warning', 'Pending'),
  createData('MNO444', 'Action Figure', '22 Sept 2021', 17, avatarApi[9], 'Jack Doe', imgApi[30], 'toys', 9, 85, 'Info', 'Paid'),
  createData('JKL345', 'Man Shoes', '19 Sept 2021', 208, avatarApi[5], 'Jessica Doe', imgApi[22], 'blur_on', 18, 33, 'Default', 'Returned'),
];

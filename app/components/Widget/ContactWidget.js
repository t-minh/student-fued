  ...
  return (
    <List>
      <ListItem button component={NavLink} to="/app/pages/chat">
        ...
        <ListItemText primary={dataContact[2].name} className={classes.messages} secondary="Do you think computers can replace teachers?" />
        <ListItemSecondaryAction>
      ...
      <ListItem button component={NavLink} to="/app/pages/chat">
        ...
        <ListItemText primary={dataContact[5].name} className={classes.messages} secondary="Do you want to go to coffee shop tomorrow? After the teaching time." />
        <ListItemSecondaryAction>
      ...
      <ListItem button component={NavLink} to="/app/pages/chat">
        ...
        <ListItemText primary={dataContact[1].name} className={classes.messages} secondary="Do you think you have a new appreciation of being a student now that you didn’t have before you became a teacher?" />
        <ListItemSecondaryAction>
          <Typography variant="caption">05 Sept</Typography>
        </ListItemSecondaryAction>
      </ListItem>
      <ListItem button component={NavLink} to="/app/pages/chat">
        <Avatar alt={dataContact[0].name} src={dataContact[0].avatar} className={classes.avatar} />
        <ListItemText primary={dataContact[0].name} className={classes.messages} secondary="Hello, how are you?" />
        <ListItemSecondaryAction>
          <Typography variant="caption">04 Sept</Typography>
        </ListItemSecondaryAction>
      </ListItem>
    </List>
  );
  ...
  return (
    <List>
      <ListItem button className={messageStyles.messageInfo}>
        ...
        <ListItemText primary="1 hour left to assign the practice test for 8A4." secondary="07 Sept 2021" />
        <Hidden xsDown>
          <ListItemSecondaryAction>
      ...
      <ListItem button className={messageStyles.messageSuccess}>
        ...
        <ListItemText primary="7A5 have done the 15 minutes quiz." secondary="6 Sept 2021" />
        <Hidden xsDown>
          <ListItemSecondaryAction>
            <Button variant="outlined" size="small" color="primary" className={classes.button}>
              Fix it
      ...
      <ListItem button className={messageStyles.messageWarning}>
        ...
        <ListItemText primary="60 minutes test score update has expired." secondary="5 Sept 2021" />
        <Hidden xsDown>
          <ListItemSecondaryAction>
            <Button variant="outlined" size="small" color="primary" className={classes.button}>
              Fix it
      ...
      <ListItem button className={messageStyles.messageError}>
        ...
        <ListItemText primary="Something went wrong." secondary="4 Sept 2021" />
        <Hidden xsDown>
          <ListItemSecondaryAction>
            <Button variant="outlined" size="small" color="primary" className={classes.button}>
              Fix it
